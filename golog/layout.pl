...
Module to load a Pacman maze from a text file as used in the Berkeley
Pacman AI projects. To be used in the 2nd lab assignment of the course
'Knowledge Representation and High-Level Control' in WS 2018/2019 at
FH Aachen.
