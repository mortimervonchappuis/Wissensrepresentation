...
/* This file has been adapted to include 'nil' as empty program and
avoid backtracking over restoreSitArg/3. Used in the 3rd lab
assignment of the course 'Knowledge Representation and High-Level
Control' in WS 2018/2019 at FH Aachen. Changes due to Jens Classen
(j.classen@fh-aachen.de) */
...
holds(A,S) :- restoreSitArg(A,S,F) -> F ; isAtom(A), A.

isAtom(A) :- \+ (A = -_W ; A = (_W1 & _W2) ; A = (_W1 => _W2) ;
    A = (_W1 <=> _W2) ; A = (_W1 v _W2) ; A = some(_X,_W) ; A = all(_X,_W)).
